...
private:
    ...
    {
        std::cout << "required layers: " << validationLayers.size() << '\n';
        ...
        std::cout << availableLayers .size() << " available Layers:\n";
    ...
    void createInstance()
    {
        ...
        // create instance with create info 
    ...
    void cleanup()
    {
        ...
        // swapChainImages will be destroyed with swapChain
        vkDestroySwapchainKHR(device, swapChain, nullptr);
        vkDestroyDevice(device, nullptr);
        // physicalDevice:: This object will be implicitly destroyed when the VkInstance is destroyed
        if (enableValidationLayers)
        {
